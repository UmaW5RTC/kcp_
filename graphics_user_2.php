...
<body>
    ...
    <div id="container">
    	<div id="header">
            ...
            <ul>
                 <li>
                    <a href="user_type_2.php" title="Back to Graphics & Tabular & Historical Data & Export View">Back to Graphics & Tabular & Historical Data & Export View</a>
                </li>
        </ul>
     </div>
        <div id="body">
...
/*		   $result_1="select * from `log_database` where site_code=".$value."";
			...
			while($sq = mysql_fetch_array($retval1, MYSQL_ASSOC))
	{
	 ...
	 $con = mysql_connect("localhost","onl12769","diet%A4B5");
		...
		$user_id = mysql_real_escape_string(trim($_POST['channel']));
		// The Chart table 
			$sth = mysql_query("		
		...
		where project_code='".$_SESSION["project_code"]."' AND channel_1_id='".$user_id."'
        UNION
	select b.site_code,b.time_stamp,b.channel_2_id,b.channel_2_value,a.project_code  
	    ...
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where project_code='".$_SESSION["project_code"]."' AND channel_2_id='".$user_id."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_3_id,b.channel_3_value,a.project_code  
	    ...
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where project_code='".$_SESSION["project_code"]."' AND channel_3_id='".$user_id."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_4_id,b.channel_4_value,a.project_code  
	    ...
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where project_code='".$_SESSION["project_code"]."' AND channel_4_id='".$user_id."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_5_id,b.channel_5_value,a.project_code  
	    ...
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where project_code='".$_SESSION["project_code"]."' AND channel_5_id='".$user_id."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_6_id,b.channel_6_value,a.project_code  
	    ...
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where project_code='".$_SESSION["project_code"]."' AND channel_6_id='".$user_id."'");
		...
		*/
		...
		while($r = mysql_fetch_assoc($sth)) {
			...
			$temp[] = array('v'  => (string) $r['channel_1_value']); 
			$rows[] = array('c' => $temp);
