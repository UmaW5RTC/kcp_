...
function showUser(str) {
  ...
  xmlhttp.open("GET","site_id_delete.php?q="+str,true);
  xmlhttp.send();
}
</script>
</head>
             ...
             <form>
			  ...
			  include ('conn.php');
				$result = mysql_query("SELECT * FROM `site_table`");
					echo 'Site Delete<select name="users" onchange="showUser(this.value)" style="width:160px; height:29px; margin-left:5px;" required tabindex="1">';
