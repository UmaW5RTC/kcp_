...
{
	$parameter_id=$_GET['delete'];
	$dis=mysql_query("delete from `parameter_table` where s_no='$parameter_id'");
	echo "Your Deleted successfully<br/>
	<a href='parameter_delete.php'>Back to Parameter Delete page</a>";
}
?>
</center>
        </div>
