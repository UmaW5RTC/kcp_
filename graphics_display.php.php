...
include('conn.php');
		...
		// The Chart table 
			$sth = mysql_query("		
		select b.site_code,b.time_stamp,b.channel_1_id,b.channel_1_value,b.channel_1_output,a.project_code 
					  from 
		log_database b 
		           inner join 
	    site_table a 
        ...
        UNION
	select b.site_code,b.time_stamp,b.channel_2_id,b.channel_2_value,b.channel_2_output,a.project_code  
					  from 
		log_database b 
		           inner join 
	    site_table a 
		...
		where b.site_code='".$site_graphic."' AND    channel_2_id='".$q."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_3_id,b.channel_3_value,b.channel_3_output,a.project_code  
					  from 
		log_database b 
		           inner join 
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where channel_3_id='".$q."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_4_id,b.channel_4_value,b.channel_4_output,a.project_code  
					  from 
		log_database b 
		           inner join 
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where channel_4_id='".$q."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_5_id,b.channel_5_value,b.channel_5_output,a.project_code  
					  from 
		log_database b 
		           inner join 
	    site_table a 
		           on 
	    b.site_code=a.site_code 
		where  channel_5_id='".$q."'
		  UNION
	select b.site_code,b.time_stamp,b.channel_6_id,b.channel_6_value,b.channel_6_output,a.project_code  
					  from 
		log_database b 
		           inner join 
	    site_table a 
