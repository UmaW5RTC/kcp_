...
function showUser(str) {
  ...
  xmlhttp.open("GET","display_user.php?q="+str,true);
  xmlhttp.send();
}
</script>
...
<div id="menu">
            <ul>
                 <li >
                    <a href="tabular_user_1.php" title="Tabular View">Tabular View</a>
                </li>
                 <li >
                    <a href="graphics_user_1.php" title="Graphics View">Graphics View</a>
                </li>
        </ul>
 </div>
        <div id="body">
    ...
    <div class="right"><br/>
             Select the parameter you want to monitor<br/><br/>
             Choose Between Graphical Display or Tabular Display<BR/><br/>
             
             <center><div id="txtHint"><b>Select particular Site Code.</b></div></center>
        </div>
    </div>
</body>
</html>