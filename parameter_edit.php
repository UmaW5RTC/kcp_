...
function showUser(str) {
  ...
  xmlhttp.open("GET","parameter_id_edit.php?q="+str,true);
  xmlhttp.send();
}
</script>
</head>
             ...
             <form>
			  ...
			  include ('conn.php');
				$result = mysql_query("SELECT * FROM `parameter_table`");
					echo 'Parameter Edit<select name="users" onchange="showUser(this.value)" style="width:160px; height:29px; margin-left:5px;" required tabindex="1">';
